...
function updateQuestLog(quest = 1) {
	let log = document.getElementById('questLog');
	if (quest === 1) { log.value = msg1 }
	else if (quest === 2) { log.value = msg2 }
	else if (quest === 3) { log.value = msg3 }
	else if (quest === 4) { log.value = msg4 }
	else if (quest === 5) { log.value = msg5 }
}
...
function fight1() {
	...
	if (rdm4 <= renemyevade) {
		...
		attackp = Math.round(((str * .5) + (str * Math.random() * 1) + (addstr * 1) + (attackb * 1) - (earmor * 1)) * (att * 1));
		if (attackp <= 0) { attackp = 0 };
...
/////////////////////////////////////////
// 			BEGIN ENCOUNTER CHANCES
/////////////////////////////////////////

function encounter(quest) {
	let rng = Math.round(Math.random() * 99);
	console.log('Encounter - Quest : ' + quest + ', RNG : ' + rng);
	if (quest === 1) {
		if (rng <= 20) { a1(); }
		else if (rng <= 40 && rng >= 21) { a2(); }
		else if (rng <= 70 && rng >= 41) { a3(); }
		else if (rng >= 71) { a4(); }
	}
	else if (quest === 2) {
		if (rng <= 20) { a4() }
		else if (rng <= 40 && rng >= 21) { a6() }
		else if (rng <= 70 && rng >= 41) { a7() }
		else if (rng >= 71) { a8() }
	}
	else if (quest === 3) {
		if (rng <= 10) { a8() }
		else if (rng <= 30 && rng >= 11) { a10() }
		else if (rng <= 50 && rng >= 31) { a11() }
		else if (rng <= 70 && rng >= 51) { a12() }
		else if (rng >= 71) { a13() }
	}
	else if (quest === 4) {
		if (rng <= 10) { a13() }
		else if (rng <= 30 && rng >= 11) { a15() }
		else if (rng <= 50 && rng >= 31) { a16() }
		else if (rng <= 70 && rng >= 51) { a17() }
		else if (rng >= 71) { a18() }
	}
	else if (quest === 5) {
		if (rng <= 20) { a20() }
		else if (rng <= 30 && rng >= 21) { a21() }
		else if (rng <= 50 && rng >= 31) { a22() }
		else if (rng <= 60 && rng >= 51) { a23() }
		else if (rng <= 80 && rng >= 61) { a24() }
		else if (rng >= 81) { a25() }
	}
}

/////////////////////////////////////////
// 			END ENCOUNTER CHANCES
/////////////////////////////////////////
...
function cast2() {
	if (currentmp >= 8) {
		...
		attackp = Math.round((Math.random() * 10) + (mag * .8) - (marmor * 1));
...
function cast3() {
	if (currentmp >= 10) {
		currentmp = (currentmp * 1) - (10 * 1);
		attackp = Math.round((Math.random() * 10) + (mag * .9) - (marmor * 1));
		if (attackp <= 0) { attackp = 1 };
...
function cast4() {
	if (currentmp >= 12) {
		...
		attackp = Math.round((Math.random() * 10) + (mag * 1) - (marmor * 1));
		if (attackp <= 0) { attackp = 1 };
...
function cast5() {
	if (currentmp >= 20) {
		...
		attackp = Math.round((Math.random() * 12) + (mag * .65) - (marmor * 1));
		if (attackp <= 0) { attackp = 1 };
		alert("You cast drain and took " + attackp + " hp from the enemy.");
		currenthp = (currenthp * 1) + (attackp * 1);
		if (currenthp >= maxhp) { currenthp = maxhp };
		showstat();
		survive();
		showstat();
...
function cast7() {
	if (currentmp >= 35) {
		...
		attackp = Math.round((Math.random() * 30) + (mag * 2) - (marmor * 1));
		if (attackp <= 0) { attackp = 1 };
...
function cast8() {
	if (currentmp >= 40) {
		currentmp = (currentmp * 1) - (40 * 1);
		attackp = Math.round((Math.random() * 30) + (mag * 2.15) - (marmor * 1));
		if (attackp <= 0) { attackp = 1 };
...
function cast17() {
	if (currentmp >= 50) {
		currentmp = (currentmp * 1) - (50 * 1);
		attackp = Math.round((mag * 1.5) + (mag * Math.random() * 1.8) - (marmor * 1));
		if (attackp <= 0) { attackp = 1 };
